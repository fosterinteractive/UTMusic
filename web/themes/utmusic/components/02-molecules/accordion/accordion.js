Drupal.behaviors.accordion = {
  attach(context) {
    ...
    expandButton.addEventListener('click', (e) => {
      let expandButtonState = expandButton.getAttribute('data-accordion-state');
      ...
      if (expandButtonState === 'expanded') {
        expandButton.setAttribute('data-accordion-state', 'collapsed');
      } else {
        expandButton.setAttribute('data-accordion-state', 'expanded');
      }
