  ...
  Drupal.behaviors.munkMmenuConfiguration = {
    attach: function attach(context, settings) {
      $('body').each(function() {
        ...
        // var $closeIcon = '<svg class="a-button--icon__icon" aria-hidden="true"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/themes/mainspring-theme/dist/icons.svg#cross"></use></svg>';
        ...
        if ($mobileMenu.length > 0) {
          var menu = new Mmenu("#menu-mobile", {
            ...
            navbars: [
              {
                'position': 'top',
                'content': '<div class="m-menu-mobile__header"><div class="m-menu-mobile__close"><button data-mobile-menu-close class="m-menu-mobile__btn-close"><i><svg class="a-button--icon__icon" aria-hidden="true"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="/themes/mainspring-theme/dist/icons.svg#cross"></use></svg></i><span class="u-visually--hidden">Close Menu</span></button></div></div>'
              }
            ],
